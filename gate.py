    ...
    def my_system():
        try:
            while True:
                ...
                continue_or_exit = input("Press enter key to continue, 'x' to exit ")
    ...
    def hunter_gate(self):
        try:
            if self.menu_option_choice == 0:
                ...
                string_to_encrypt = str(input("[*] (String, use 'x' to exit)>> "))
                ...
                ipv4_address = str(input("[*] (IPv4, use 'x' to exit)>> "))
                ...
                ipv4_address = str(input("[*] (IPv4, use 'x' to exit)>> "))
                target_port = int(input("[*] (Port, use '0' to exit)>> "))
                ...
                url_ps = str(input("[*] (Phonenumber, use 'x' to exit)>> "))
                ...
                url_sds = str(input("[*] (URL, use 'x' to exit)>> "))
                ...
                url_gipv4u = str(input("[*] (URL, use 'x' to exit)>> "))
                ...
                passw_length = int(input("[*] (Password length, use 'x' to exit)>> "))
                ...
                url_whois = str(input("[*] (URL, use 'x' to exit)>> "))
                ...
                url_ghttph = str(input("[*] (URL, use 'x' to exit)>> "))
                ...
                url_lc = str(input("[*] (URL, use 'x' to exit)>> "))
                ...
                addr = str(input("[*] (Address, use 'x' to exit)>> "))
