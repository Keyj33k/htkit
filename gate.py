        ...
        try:
            if self.menu_option_choice == 0:
                ...
                if ip_gipv4u == 'x' or ip_gipv4u == 'exit':
                    print(f"{w}[{o}-{w}] Sorry, But command '{ip_gipv4u}' is invalid. Please use Ctrl+C to exit Witcher!")
                ...
                if ipv4_address == 'x' or ipv4_address == 'exit':
                    print(f"{w}[{o}-{w}] Sorry, But command '{ipv4_address}' is invalid. Please use Ctrl+C to exit BannerGrabber!")
                ...
                if url_sds == 'x' or url_sds == 'exit':
                    print(f"{w}[{o}-{w}] Sorry, But command '{url_sds}' is invalid. Please use Ctrl+C to exit SubdomainScanner!")
                ...
                if ipv4 == 'x' or ipv4 == 'exit':
                    print(f"{w}[{o}-{w}] Sorry, But command '{ipv4}' is invalid. Please use Ctrl+C to exit IPSweep!")
                ...
                gs_url = str(input(f"{w}[{r}*{w}] ({pwd.getpwuid(os.getuid())[0]}{r}@{w}Hunter, Address)>> "))
