...
def menu():
    ...
    print(
        green + "{" + red + "1" + green + "} " +
        cyan + " Witcher\t\t\t" + yellow + " A simple port scanner."
    )
    print(
        green + "{" + red + "2" + green + "} " +
        cyan + " MD5Crypt\t\t\t" + yellow + " MD5 encryption."
    )
    print(
    ...
    print(
        ...
        " Ping\t\t\t" + yellow + " Check host availability.\n"
    )
    print(
        green + "{" + red + "99" + green + "}" + cyan + " Exit\n"
    )
    print(magenta + "=" * 70)
