...
class Hunter:
    ...
    def menu():
        ...
        print(green   + "{"   + red + "3"   + green + "} " + cyan + " WhoisForIP\t\t"      + yellow + " Get informations about an ip address.")
        ...
        print(green   + "{"   + red + "13"  + green + "}"  + cyan + " WhoisForURL\t"       + yellow + " Whois lookup for URL.")
        print(green   + "{"   + red + "14"  + green + "}"  + cyan + " Header\t\t"          + yellow + " Get header from url.\n")
    ...
    def get_header():
        passgen_banner          = pfgt.figlet_format("GHeader", font="banner3-D")
        print(cld(passgen_banner, "cyan"))
        print(magenta           + "#" * 24 + green, " *writtenby@Keyj33k " + magenta, "#" * 24 + "\n")
        ...
        if header_from == 'x' or header_from == 'exit':
            ...
            os.system(f"curl -I {header_from}")
    ...
    def md5():
        ...
        try:
            ...
            input(cyan      + "Press any key to continue")
            Hunter.md5() # https://www.md5online.org/md5-decrypt.html This program is using a big database to bruteforce the hash for you
