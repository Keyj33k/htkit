    ...
    def hunter_gate(self):
        try:
            if self.menu_option_choice == 0:
                ...
                print(f"\n\033[0;37m[\033[0;31m*\033[0;37m] Goodbye, {os.getlogin()}. Follow the white rabbit ...\n")
                sys.exit(0)
            else:
...
if __name__ == "__main__":
    while True:
        call(["clear"])
        print(f"\033[0;37m[\033[0;31m*\033[0;37m] Welcome, {os.getlogin()}!")
        ...
        while True:
            ...
            if start == 'y' or start == 'Y':
                ...
                print(f"\033[0;37m[\033[0;31m*\033[0;37m] Goodbye, {os.getlogin()}. Follow the white rabbit ...\n")
                sys.exit(0)
            else:
                print("\033[0;37m[\033[0;31m*\033[0;37m] Invalid Input!")
